# ISTV Slack Bot — Claude Code Context
...
│   ├── claude.js              ← Claude API: DLOA analysis, Q&A, summaries
...
6. RAG search returns top 5 chunks, fed as context to Claude before answering
...
10. @mention handler: app_mention Slack event → search knowledge base → Claude answers in thread
